...
class News extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id', 'updated', 'is_published', 'created_user_id', 'updated_user_id', 'sort_index'], 'integer'],
            [['title_ru', 'title_kz', 'title_en', 'photo', 'slug', 'link_ru', 'link_kz', 'link_en'], 'string', 'max' => 255],
            [['title_ru', 'description_ru', 'created', 'link_ru'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'slug' => Yii::t('app', 'Slug'),
            'link_ru' => Yii::t('app', 'Link Ru'),
            'link_kz' => Yii::t('app', 'Link Kz'),
