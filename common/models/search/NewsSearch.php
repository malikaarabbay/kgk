...
class NewsSearch extends News
{
    ...
    public function rules()
    {
        return [
            ...
            [['title_ru', 'title_kz', 'title_en', 'description_ru', 'description_kz', 'description_en', 'anounce', 'photo', 'meta_keywords', 'meta_description', 'slug', 'link_ru', 'link_kz', 'link_en'], 'safe'],
        ];
    }
